[原文](https://juejin.cn/post/7007245485001932814)<br />Hey guys，这里是程序员cxuan，欢迎你收看我最新一期的文章，这篇文章我补充了一些关于《Java基础核心总结》的内容，修改了部分错别字和语句不通顺的地方，并且对内部类、泛型等内容进行了一定的补充，并且我在文章有些地方给出了一些链接，这些链接都是我自己写的硬核文章，能够更好的帮助你理解 Java 这门语言，那么废话不多说，下面开始正文。
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8d6f20a6d03343fba1187bad3d6c15a1~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=BDz6D&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4a65ce1fedce4e98a69554a6266f837f~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=ZHsLe&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bca2aafa4184448aa796f5a80675f7a4~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=gWnKT&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
C++ 中模板的实例化会为每一种类型都产生一套不同的代码，这就是所谓的代码膨胀。Java 中并不会产生这个问题。虚拟机中并没有泛型类型对象，所有的对象都是普通类。 （摘自：[blog.csdn.net/fw0124/arti…](https://link.juejin.cn/?target=http%3A%2F%2Fblog.csdn.net%2Ffw0124%2Farticle%2Fdetails%2F42295463%25EF%25BC%2589)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/745e428048204c09b3f25fa7f3953600~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=Ls40P&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4a266dcfe99e433db0982653865ff4c3~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=KkMTW&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

深入理解反射，可以阅读作者的这篇文章 [学会反射后，我被录取了！（干货）](https://link.juejin.cn/?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzkwMDE1MzkwNQ%3D%3D%26mid%3D2247495851%26idx%3D1%26sn%3Dfe53ba6e2f2d1098fb0c8cd82420e885%26chksm%3Dc04ae7f5f73d6ee35caa07a1ecb649d99aba9248e0db1178c0526f524c9f1f66abe37f76a246%26token%3D1680060231%26lang%3Dzh_CN%23rd)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3b9b68e4be4248618c52bab461cdf61d~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=e3ccK&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/10bb49801d5a42d4afa2817f87dd9100~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=fFoBc&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/aba7a675211f4e1aabcdd168bca4823f~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=jTh0U&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e7842ddd8ae44bbfbd31f14383bdc949~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=kQCe9&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

I/O 还可以根据操作对象来进行区分：主要分为

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e76311708d43490596273d874e8532f6~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=kRlbA&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d1605c590f1c41338de08af768740f15~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=fIQUg&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4beee6bd88ac4f04a416f54f20cc59b0~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=HvJRD&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/efc8f54a7d2f4b209e2d9db4e14abe51~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=GeOZl&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1510e9cc5449411289766621fc55e0d4~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=XcXuD&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3f33d85e3e744ef2a7c5e8ad7c59710b~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=BDpwq&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
深入理解 Java IO ，你可以阅读作者的这篇文章 [深入理解 Java IO](https://link.juejin.cn/?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzkwMDE1MzkwNQ%3D%3D%26mid%3D2247495827%26idx%3D1%26sn%3D3fb5ed6663e4ebe90a970d11e00e1a64%26chksm%3Dc04ae7cdf73d6edb041e35b75913c90f3d88d2977d3e76d567766cecb3279f9692846580a9e5%26token%3D1680060231%26lang%3Dzh_CN%23rd)
...
-  `@SafeVarargs` ：在声明可变参数的构造函数或方法时，Java 编译器会报 unchecked 警告。使用 [@SafeVarargs ](/SafeVarargs ) 可以忽略这些警告  
...
声明周期配合 [@Retention ](/Retention ) 来使用，使用方法如下： 
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/06eba33995274505846ede518c621cc5~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=kKhSf&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/01464ab232264b27a613b437b2f032cf~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=aDYBq&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2e50e312ee134a888bebc7a5beb5cdec~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.image#crop=0&crop=0&crop=1&crop=1&id=DkbV0&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
如果文章对你有帮助的话，希望大家给我点个赞哦！！！

本文转自 [https://juejin.cn/post/7007245485001932814](https://juejin.cn/post/7007245485001932814)，如有侵权，请联系删除。
